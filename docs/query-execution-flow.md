...
1. [`src/application/run-query.ts`](../src/application/run-query.ts) — the end-to-end entry point.
...
4. [`src/workers/capability-dispatcher.ts`](../src/workers/capability-dispatcher.ts) — capability-safe routing.
